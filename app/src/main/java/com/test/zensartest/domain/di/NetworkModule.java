...
import com.test.zensartest.common.Constants;
import com.test.zensartest.data.service.DataSource;
import com.test.zensartest.data.service.DataSourceImpl;
import com.test.zensartest.data.service.ZensarService;
...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    public ZensarService provideZensarService(Retrofit retrofit) {
        return retrofit.create(ZensarService.class);
    }

    @Provides
    @Singleton
    public DataSource provideDataSource(ZensarService zensarService) {
        return new DataSourceImpl(zensarService);
    }
